"""
4.1 – Pizzas: Pense em pelo menos três tipos de pizzas favoritas. Armazene os nomes dessas pizzas e, então, utilize um laço for para exibir o nome de cada
pizza.
...
print()
for pizza in pizzas:
    print(f"Gosto de pizza de {pizza.lower()}.")
